...
TMS.obj : TMS.cpp TMS.h    Logical_Architecture.h HVAC.h IB_Heater.h IB_Cooler.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"TMS.obj" "TMS.cpp" 



HVAC.obj : HVAC.cpp HVAC.h    Logical_Architecture.h TMS.h Heater.h Cooler.h IB_Heater.h IB_Cooler.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"HVAC.obj" "HVAC.cpp" 



IB_Heater.obj : IB_Heater.cpp IB_Heater.h    Logical_Architecture.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"IB_Heater.obj" "IB_Heater.cpp" 



IB_Cooler.obj : IB_Cooler.cpp IB_Cooler.h    Logical_Architecture.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"IB_Cooler.obj" "IB_Cooler.cpp" 



Heater.obj : Heater.cpp Heater.h    Logical_Architecture.h IB_Heater.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Heater.obj" "Heater.cpp" 



Cooler.obj : Cooler.cpp Cooler.h    Logical_Architecture.h IB_Cooler.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Cooler.obj" "Cooler.cpp" 



Logical_Architecture.obj : Logical_Architecture.cpp Logical_Architecture.h    TMS.h HVAC.h IB_Heater.h IB_Cooler.h Heater.h Cooler.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Logical_Architecture.obj" "Logical_Architecture.cpp" 
...
clean:
	...
	if exist IB_Heater.obj erase IB_Heater.obj
	if exist IB_Cooler.obj erase IB_Cooler.obj
	if exist Heater.obj erase Heater.obj
	if exist Cooler.obj erase Cooler.obj
	if exist Logical_Architecture.obj erase Logical_Architecture.obj
