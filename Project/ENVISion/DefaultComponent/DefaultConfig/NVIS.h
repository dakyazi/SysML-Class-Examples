...
//#[ ignore
    //## package System_Analysis::System_Context
    class port_NVIS_C : public IB_NVIS {
...
//#]
    ...
    //## auto_generated
    port_NVIS_C* getPort_NVIS(void) const;
    
    //## auto_generated
    port_NVIS_C* get_port_NVIS(void) const;
