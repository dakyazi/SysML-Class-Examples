...
//!	Generated Date	: Tue, 23, Apr 2024  
	File Path	: DefaultComponent\DefaultConfig\MonitoringScreen.h
*********************************************************************/
...
#ifdef _OMINSTRUMENT
    friend class OMAnimatedMonitoringScreen;
#endif // _OMINSTRUMENT
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedMonitoringScreen : virtual public AOMInstance {
    DECLARE_META(MonitoringScreen, OMAnimatedMonitoringScreen)
