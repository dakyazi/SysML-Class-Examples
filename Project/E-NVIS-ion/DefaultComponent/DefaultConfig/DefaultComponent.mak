...
OBJS= \
  ...
  CentralProcessingUnit.obj \
  AutoLightControlUnit.obj \
  Headlights.obj \
...
NVIS.obj : NVIS.cpp NVIS.h    System_Context.h HighResVideoCam.h InfraredFilter.h Standards.h NaturalEnvironment.h CommunicationSystem.h Constraints.h Stakeholder.h Headlights.h AutoLightControlUnit.h CentralProcessingUnit.h MonitoringScreen.h Car.h 
	$(CREATE_OBJ_DIR)
...
HighResVideoCam.obj : HighResVideoCam.cpp HighResVideoCam.h    System_Context.h NVIS.h CentralProcessingUnit.h AutoLightControlUnit.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"HighResVideoCam.obj" "HighResVideoCam.cpp" 



InfraredFilter.obj : InfraredFilter.cpp InfraredFilter.h    System_Context.h NVIS.h CentralProcessingUnit.h 
	$(CREATE_OBJ_DIR)
...
CentralProcessingUnit.obj : CentralProcessingUnit.cpp CentralProcessingUnit.h    System_Context.h NVIS.h InfraredFilter.h HighResVideoCam.h Headlights.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"CentralProcessingUnit.obj" "CentralProcessingUnit.cpp" 



AutoLightControlUnit.obj : AutoLightControlUnit.cpp AutoLightControlUnit.h    System_Context.h NVIS.h HighResVideoCam.h Headlights.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"AutoLightControlUnit.obj" "AutoLightControlUnit.cpp" 



Headlights.obj : Headlights.cpp Headlights.h    System_Context.h NVIS.h CentralProcessingUnit.h AutoLightControlUnit.h 
	$(CREATE_OBJ_DIR)
...
Car.obj : Car.cpp Car.h    System_Context.h NVIS.h 
	$(CREATE_OBJ_DIR)
...
System_Context.obj : System_Context.cpp System_Context.h    NVIS.h Stakeholder.h Constraints.h HighResVideoCam.h InfraredFilter.h Standards.h NaturalEnvironment.h CommunicationSystem.h CentralProcessingUnit.h AutoLightControlUnit.h Headlights.h MonitoringScreen.h Car.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"System_Context.obj" "System_Context.cpp" 



NVIS_Operating_Environment.obj : NVIS_Operating_Environment.cpp NVIS_Operating_Environment.h    NVIS.h HighResVideoCam.h InfraredFilter.h NaturalEnvironment.h CentralProcessingUnit.h AutoLightControlUnit.h Headlights.h CommunicationSystem.h 
	$(CREATE_OBJ_DIR)
...
clean:
	...
	if exist CentralProcessingUnit.obj erase CentralProcessingUnit.obj
	if exist AutoLightControlUnit.obj erase AutoLightControlUnit.obj
